...
namespace CTool.CControl
{
    ...
    /// 调用:panelEx1.InitMouseAndContolStyle(AppDomain.CurrentDomain.BaseDirectory + "App.xml");
    /// </summary>
    public partial class PanelEx : Panel
    {
        ...
        string xml内容 = @"<?xml version='1.0' encoding='utf-8'?>
                            <Form1>
                              <panel1>
        ...
        string 调用例子 = @"panelEx2.InitMouseAndContolStyle(AppDomain.CurrentDomain.BaseDirectory + 'file.xml');";
    }
